    ...
    const handleVerification = async () => {
      try {
        ...
        const response = await Request(
          'https://api.bandla.uz/auth/verification/check-confirmation-code',
          'put',
          null,
          requestData
        );
    ...
    <>
      {isPasswordFormVisible ? (
        ...
        <div className="login-wrapper">
          <Card
            sx={{ minWidth: '200px', width: '600px', borderRadius: '12px' }}
          >
            <CardContent
              sx={{
                p: '30px',
            ...
            >
              ...
              <Typography
                sx={{ fontWeight: 'regular', my: '20px', fontSize: '19px' }}
              >
                <b>+998 {phoneNumber}</b> telefon raqamini tasdiqlash uchun
                <br /> 4 xonali kod yubordik
              </Typography>
